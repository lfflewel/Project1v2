...
//                         console.log("Decks " + decks+  "Inserted");
...
app.post('/createCards'), function(req, req) {
    if (req.session.loggedin) {
        let cards = req.body.cards;

        con.query(`INSERT INTO Cards (cardID, cardQuestion, cardAnswer) VALUES ("${cards}"), ${cardQuestion}, ${cardAnswer});`, 
